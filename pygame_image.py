...
def main():
    ...
    k_img = pg.image.load("ex01-20231121/fig/3.png")
    k_img = pg.transform.flip(k_img, True, False)
    k_imgs =[k_img,pg.transform.rotozoom(k_img, 3, 1.0), pg.transform.rotozoom(k_img, 6, 1.0), pg.transform.rotozoom(k_img, 10, 1.0)]
